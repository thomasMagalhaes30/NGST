...
/* harmony import */ var _apod_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./apod.component.html?ngResource */ 9935);
/* harmony import */ var _apod_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apod.component.scss?ngResource */ 3);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _app_services_nasaApod_nasa_apod_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/services/nasaApod/nasa-apod.service */ 6131);





let ApodComponent = class ApodComponent {
    constructor(_nasa) {
        this._nasa = _nasa;
        this.loadTodayApodOnInit = true;
        this._apod = {};
    }
    get apod() {
        return this._apod;
    ...
    fetchObservableApod(myObservableApod) {
...
ApodComponent.ctorParameters = () => [
    { type: _app_services_nasaApod_nasa_apod_service__WEBPACK_IMPORTED_MODULE_2__.NasaApodService }
];
ApodComponent.propDecorators = {
    loadTodayApodOnInit: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__.Input }],
    apod: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__.Input }]
};
ApodComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        selector: 'app-apod',
        template: _apod_component_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_apod_component_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], ApodComponent);
...
/***/ 6131:
/*!********************************************************!*\
  !*** ./src/app/services/nasaApod/nasa-apod.service.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NasaApodService": () => (/* binding */ NasaApodService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 4929);
...
let NasaApodService = NasaApodService_1 = class NasaApodService {
    constructor(_httpClient) {
        this._httpClient = _httpClient;
    }
    getApodByDateObject(d) {
     ...
     */
    static randomDate(start = new Date("1995-06-16"), end = new Date()) {
        return new Date(start.getTime() + Math.random() * (end.getTime() - start.getTime()));
    }
    getApodByDate(year, month, day) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpParams();
        if (year && month && day) {
            params = params.set('date', `${year}-${month}-${day}`);
        }
        params = params.set('api_key', _env_environment__WEBPACK_IMPORTED_MODULE_0__.environment.nasaApiKey);
        // en cas d'erreur on retourne un apod par défaut
        return this._httpClient.get(`https://api.nasa.gov/planetary/apod`, { params })
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(error => {
            let defaultApod = Object.assign({}, NasaApodService_1.defaultApod);
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpErrorResponse) {
                defaultApod.title = `Une erreur ${error.status} est survenu`;
            }
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.of)(defaultApod);
        }));
    }
    getRandomApod() {
        return this.getApodByDateObject(NasaApodService_1.randomDate());
    }
    getTodayApod() {
        return this.getApodByDate();
    }
};
NasaApodService.defaultApod = {
    resource: "",
    concept_tags: "",
...
NasaApodService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
NasaApodService = NasaApodService_1 = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_home_godzi_Documents_etude_licence_p3_web_transverse_NGST_ngst_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_home_godzi_Documents_etude_licence_p3_web_transverse_NGST_ngst_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_godzi_Documents_etude_licence_p3_web_transverse_NGST_ngst_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_home_godzi_Documents_etude_licence_p3_web_transverse_NGST_ngst_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
/***/ 3:
/*!****************************************************************!*\
  !*** ./src/app/components/apod/apod.component.scss?ngResource ***!
  \****************************************************************/
/***/ ((module) => {
...
/***/ 9935:
/*!****************************************************************!*\
  !*** ./src/app/components/apod/apod.component.html?ngResource ***!
  \****************************************************************/
/***/ ((module) => {

module.exports = "<ion-card>\n  <ion-card-header>\n    <ion-card-title>{{apod.title}}</ion-card-title>\n<!--    <ion-card-subtitle>Card Subtitle</ion-card-subtitle>-->\n  </ion-card-header>\n\n  <ion-card-content [ngSwitch]=\"apod.media_type\">\n    <div class=\"ion-text-center\" *ngSwitchCase=\"['image', 'error'].includes(apod.media_type) ? apod.media_type : '' \">\n      <ion-img id=\"apodImg\" [src]=\"apod.url\" [alt]=\"apod.title\" (ionImgWillLoad)=\"onIonImgWillLoad()\"></ion-img>\n      <ion-button id=\"seeApodInHD\" (click)=\"onClickButtonHD()\">See in hd</ion-button>\n    </div>\n\n    <div class=\"ion-text-center\" *ngSwitchDefault>\n      <ion-button [href]=\"apod.url\" target=\"_blank\" >Open url</ion-button>\n    </div>\n\n    <p>{{apod.explanation}}</p>\n    <span *ngIf=\"apod.copyright\" class=\"ion-float-end\">© {{apod.copyright}}</span>\n  </ion-card-content>\n</ion-card>\n";
